    ...
    return (
        <Layout>
            <div className="w-full h-full flex flex-col justify-center items-center z-0 py-10">
                ...
                sm:gap-20 xl:gap-20 px-20 my-5">

                        <div className="items-center justify-center w-1/3 h-fit sm:py-5">
                    ...
                    <div className="flex flex-col lg:flex-row justify-center w-full xl:h-fit
                sm:gap-20 xl:gap-20 px-20 py-5 bg-deep-orange-100">
                    ...
                    <div className="items-center justify-center w-1/2 h-fit sm:py-5 px-10 bg-deep-orange-100">
